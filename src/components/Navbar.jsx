...
const Navbar = () => {
  return (
    <nav className='flex flex-col lg:flex-row justify-between py-5 mx- bg-white'>
        <div>
            <input type="search" name='search' placeholder='Search Here' className='p-3 border border-yellow-500 rounded-lg w-full lg:w-[25vw] mx-9 cursor-pointer'/>
        </div>
        {/* <div> */}
        ...
        {/* </div> */}
        <div className="w-12 h-12 rounded-full overflow-hidden border border-yellow-500 mx-10 hover:scale-110">
